...
public class MR extends Configured implements Tool {
	private static final Logger LOG = LoggerFactory.getLogger(MR.class);

	static class TarDecompressMapper extends
	...
	public int run(String[] args) throws Exception {
		...
		job.setMapperClass(MR.TarDecompressMapper.class);
	...
	public static void main(String[] args) throws Exception {
		...
		;
		int exitCode = ToolRunner.run(new MR(), args);
